...
import 'SiLAService.pb.dart' as $0;
export 'SiLAService.pb.dart';
...
class SiLAServiceClient extends $grpc.Client {
  ...
  SiLAServiceClient($grpc.ClientChannel channel, {$grpc.CallOptions options})
  ...
  $grpc.ResponseFuture<$0.GetFeatureDefinition_Responses> getFeatureDefinition(
    ...
    final call = $createCall(
        _$getFeatureDefinition, $async.Stream.fromIterable([request]),
        options: options);
  ...
  $grpc.ResponseFuture<$0.SetServerName_Responses> setServerName(
      ...
      {$grpc.CallOptions options}) {
    final call = $createCall(
        _$setServerName, $async.Stream.fromIterable([request]),
        options: options);
    return $grpc.ResponseFuture(call);
  }
  ...
  $grpc.ResponseFuture<$0.Get_ServerName_Responses> get_ServerName(
      ...
      {$grpc.CallOptions options}) {
    final call = $createCall(
        _$get_ServerName, $async.Stream.fromIterable([request]),
        options: options);
    return $grpc.ResponseFuture(call);
  }
  ...
  $grpc.ResponseFuture<$0.Get_ServerType_Responses> get_ServerType(
      ...
      {$grpc.CallOptions options}) {
    final call = $createCall(
        _$get_ServerType, $async.Stream.fromIterable([request]),
        options: options);
    return $grpc.ResponseFuture(call);
  }
  ...
  $grpc.ResponseFuture<$0.Get_ServerUUID_Responses> get_ServerUUID(
      ...
      {$grpc.CallOptions options}) {
    final call = $createCall(
        _$get_ServerUUID, $async.Stream.fromIterable([request]),
        options: options);
    return $grpc.ResponseFuture(call);
  }
  ...
  $grpc.ResponseFuture<$0.Get_ServerDescription_Responses>
      get_ServerDescription($0.Get_ServerDescription_Parameters request,
          {$grpc.CallOptions options}) {
    final call = $createCall(
        _$get_ServerDescription, $async.Stream.fromIterable([request]),
        options: options);
    return $grpc.ResponseFuture(call);
  }
  ...
  $grpc.ResponseFuture<$0.Get_ServerVersion_Responses> get_ServerVersion(
      ...
      {$grpc.CallOptions options}) {
    final call = $createCall(
        _$get_ServerVersion, $async.Stream.fromIterable([request]),
        options: options);
    return $grpc.ResponseFuture(call);
  }
  ...
  $grpc.ResponseFuture<$0.Get_ServerVendorURL_Responses> get_ServerVendorURL(
      ...
      {$grpc.CallOptions options}) {
    final call = $createCall(
        _$get_ServerVendorURL, $async.Stream.fromIterable([request]),
        options: options);
    return $grpc.ResponseFuture(call);
  }
  ...
  $grpc.ResponseFuture<$0.Get_ImplementedFeatures_Responses>
      get_ImplementedFeatures($0.Get_ImplementedFeatures_Parameters request,
          {$grpc.CallOptions options}) {
    final call = $createCall(
        _$get_ImplementedFeatures, $async.Stream.fromIterable([request]),
        options: options);
    return $grpc.ResponseFuture(call);
  }
}
